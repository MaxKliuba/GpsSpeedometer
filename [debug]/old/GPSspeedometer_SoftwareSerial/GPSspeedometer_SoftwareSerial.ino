...
SoftwareSerial NextionSerial(5, 4);
...
void printTripTime()
{
  if(millis() - timerMillisTrip >= 1000 || update)
  {
...
{
  NextionSerial.print(element + "=" + "\"" + data+ "\"");
...
{
  NextionSerial.print(element + "=" + "\"");
  NextionSerial.print(data, round);
  NextionSerial.print(unit + "\"");
  NextionSerial.write(0xFF);
  NextionSerial.write(0xFF);
  NextionSerial.write(0xFF);
}
...
void Awake()
{
  if(sleep)
  {
    ...
    //detachInterrupt(0);
    page == 0;
    NextionSerial.print("page page0");
    NextionSerial.write(0xFF);
    NextionSerial.write(0xFF);
    NextionSerial.write(0xFF);
  }
